...
k8x supports the Model Context Protocol for extending capabilities with external tools and services. See [mcp.md](mcp.md) for comprehensive MCP documentation.
