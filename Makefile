...
test-mcp-integration: build ## Run integration tests (requires external dependencies)
	@echo "Running integration tests..."
	@go test -v ./test/e2e/... -run TestDuckDuckGoMCPIntegration -timeout 10m -preserve-on-failure
